...
export default function WebsTable() {
  ...
  return (
    <div className="p-6 lg:ml-[290px] lg:py-4 py-24 bg-slate-100">
      <button
        onClick={() => {
          setSelectedWeb(undefined);
          setIsOpen(true);
        }}
        className="bg-orange-500 mb-4 text-white py-2 px-4 rounded"
      >
        Tambah Data Web
      </button>
              ...
              <tr className="bg-white" key={web.id}>
                ...
                <td className="border p-2  items-center justify-center text-center">
                  <button
                    ...
                    className="bg-yellow-500 text-white px-2 m-2 py-1 rounded"
                  >
                    Edit
                  </button>
                  <button
